...
void HookChrome(string p_sModule)
{
	...
	unsigned char Read_Signature64[] = {
		0x56, 0x57, 0x48, 0x83, 0xec, 0x28, 0x48, 0x89, 0xcf, 0xe8, '?',  '?',  '?',  '?',  0x89, 0xc6,
		0x85, 0xc0, 0x7e, '?' , 0x48, 0x8b, 0x47, 0x30, 0x89, 0xf1, 0x48, 0x8b, 0x90, 0x88, 0x00, 0x00 };
	...
	else
	{
		...
		if (pRead64 == 0)
		{
			DebugLog::Log("[ERROR] Cannot get Chrome SSL read function!");
		}
		else if (pWrite64 == 0)
		{
			DebugLog::Log("[ERROR] Cannot get Chrome SSL write function!");
		}
